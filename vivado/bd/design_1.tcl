...
\
  ...
  connect_bd_intf_net -intf_net AXI_GPIO_BTN_GPIO [get_bd_intf_ports btn] [get_bd_intf_pins AXI_GPIO_BTN/GPIO]
  connect_bd_intf_net -intf_net AXI_GPIO_LED_GPIO [get_bd_intf_ports led] [get_bd_intf_pins AXI_GPIO_LED/GPIO]
  connect_bd_intf_net -intf_net axi_smc_M00_AXI [get_bd_intf_pins axi_smc/M00_AXI] [get_bd_intf_pins AXI_GPIO_BTN/S_AXI]
